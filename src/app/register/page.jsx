                ...
                >
                    ...
                    <TextField isRequired name="name" type="text">
                        ...
                        <Input
                            ...
                            className={'h-14 rounded-2xl border border-gray-200 bg-white/70 backdrop-blur-md hover:border-blue-400 focus-within:border-blue-500 transition'}
                        />
                    ...
                    >
                        ...
                        <Description className="text-xs text-gray-500 ml-1">
                    ...
                    text-white font-bold text-base shadow-lg transition-all duration-300"
                        >
                            <Check />
                            Register
                        </Button>
